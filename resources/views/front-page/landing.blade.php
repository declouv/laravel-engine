            ...
            <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-8">
                ...
                <div class="collapse navbar-collapse landing-nav-menu" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link fw-medium" href="{{ route('dashboard-analystics') }}"
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar me-3 avatar-sm">
                                                        <img src="assets/img/avatars/1-1.png" alt="Avatar"
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card h-100">
                                            <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar me-3 avatar-sm">
                                                        <img src="assets/img/avatars/2-1.png" alt="Avatar"
                                                            class="rounded-circle">
                                                    </div>
                                                    <div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card h-100">
                                            <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar me-3 avatar-sm">
                                                        <img src="assets/img/avatars/3-1.png" alt="Avatar"
                                                            class="rounded-circle">
                                                    </div>
                                                    <div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card h-100">
                                            <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar me-3 avatar-sm">
                                                        <img src="assets/img/avatars/4-1.png" alt="Avatar"
                                                            class="rounded-circle">
                                                    </div>
                                                    <div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card h-100">
                                            <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar me-3 avatar-sm">
                                                        <img src="assets/img/avatars/5-1.png" alt="Avatar"
                                                            class="rounded-circle">
                                                    </div>
                                                    <div>
                                                        <h6 class="mb-0">Eugenia Moore</h6>
                ...
                <div class="row gy-6">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card border border-success shadow-none">
                            <div class="card-body text-center">
                                <img src="assets/img/front-pages/icons/user-success.svg" alt="laptop"
                                    class="mb-4">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card border border-info shadow-none">
                            <div class="card-body text-center">
                                <img src="assets/img/front-pages/icons/diamond-info.svg" alt="laptop"
                                    class="mb-4">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card border border-warning shadow-none">
                            <div class="card-body text-center">
                                <img src="assets/img/front-pages/icons/check-warning.svg" alt="laptop"
                                    class="mb-4">
