<x-front-app>
   ...
   active">
    ...
    <section class="section-py first-section-pt help-center-header position-relative overflow-hidden">
        <img class="banner-bg-img z-n1" src="../../assets/img/pages/header-1.png" alt="Help center header">
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="card border shadow-none">
                                <div class="card-body text-center">
                                    ...
                                    <p class="mb-3"> Whether you're new or you're a power user, this article will…
                                    </p>
                                    <a class="btn btn-sm btn-label-primary" href="{{ route('frontpage-help-articles')}}">Read
                                        More</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="card border shadow-none">
                                <div class="card-body text-center">
                                    ...
                                    <p class="mb-3"> This article will show you how to expand the functionality of...
                                    </p>
                                    <a class="btn btn-sm btn-label-primary" href="{{ route('frontpage-help-articles')}}">Read
                                        More</a>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled my-6">
                                        <li class="mb-2">
                                            <a href="{{ route('frontpage-help-articles')}}"
                                    ...
                                    <p class="mb-0 fw-medium mt-6">
                                        <a href="{{ route('frontpage-help-articles')}}" class="d-flex align-items-center">
                                            <span class="me-3">See all 10 articles</span>
                                            <i class="bx bx-right-arrow-alt scaleX-n1-rtl bx-sm fw-semibold"></i>
                                        </a>
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <div class="avatar avatar-sm flex-shrink-0 me-3">
                                            <span class="avatar-initial rounded bg-label-primary"><i
                                                    class="bx bx-help-circle"></i></span>
                                        </div>
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="card border shadow-none">
                                <div class="card-body text-center">
                                    ...
                                    <p class="mb-3">Expert tips and tools to improve your website or online store
                                        using our blog.</p>
                                    <a href="{{ route('frontpage-help-articles')}}" class="btn btn-sm btn-label-primary">Read
                                        More</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-md-6">
                            <div class="card border shadow-none">
                                <div class="card-body text-center">
                                    ...
                                    <p class="mb-3">Inspiration from experts to help you start and grow your big
                                        ideas.</p>
                                    <a href="{{ route('frontpage-help-articles')}}" class="btn btn-sm btn-label-primary">Read
                                        More</a>
                                </div>
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="card border shadow-none">
                                <div class="card-body text-center">
                                    ...
                                    <p class="mb-3">A group of people living in the same place or having a
                                        particular.</p>
                                    <a href="{{ route('frontpage-help-articles')}}" class="btn btn-sm btn-label-primary">Read
                                        More</a>
                                </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 text-center">
                    ...
                    <p> Our specialists are always happy to help.<br>Contact us during standard business hours or email
                        us 24/7 and we'll get back to you. </p>
